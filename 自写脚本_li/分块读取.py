...
# author --liming--
'''
预期是希望能够实现一个按 512*512 分辨率，
将一张遥感大图分块输出
'''


path = r"E:\工作相关\中科云遥\工作\影像\22年9月重采样_5m\JL1KF01B_PMSL1_20220903103003_200100082_101_0032.tif"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_path',
                        default=r"C:\Users\Jason\Desktop\新建文件夹\新建文件夹",
                        help='remote sensing image path')
    parser.add_argument('--patch_size',
                        default=250,
                        help='patch size')
    parser.add_argument('--patch_save',
                        default=r'C:\Users\Jason\Desktop\新建文件夹\save',
    ...
    for k in range(image_num):
        ...
        img_name = os.path.join(image_path,image_list[k])
